...
INSERT INTO Users (Id, DocumentType, IdentityDocument, Name, Email, Phone, UserStatus, BirthDate, AccountCreationDate, Discriminator) VALUES
(1, 'Cedula', 123456789, 'John Doe', 'johndoe@example.com', '1234567890', 'Active', '1990-01-01', GETDATE(), 'user'),
(2, 'Cedula', 987654321, 'Jane Smith', 'janesmith@example.com', '0987654321', 'Inactive', '1992-02-02', GETDATE(), 'user'),
(3, 'Cedula', 112233445, 'Alice Johnson', 'alicejohnson@example.com', '1231231234', 'Active', '1985-03-03', GETDATE(), 'user'),
(4, 'Cedula', 556677889, 'Bob Brown', 'bobbrown@example.com', '3213214321', 'Inactive', '1988-04-04', GETDATE(), 'user'),
(5, 'Cedula', 998877665, 'Charlie Davis', 'charliedavis@example.com', '4564564567', 'Active', '1991-05-05', GETDATE(), 'user'),
(6, 'Cedula', 111222333, 'David Harris', 'davidharris@example.com', '1112223333', 'Active', '1993-06-06', GETDATE(), 'user'),
(7, 'Cedula', 444555666, 'Eva Green', 'evagreen@example.com', '4445556666', 'Inactive', '1994-07-07', GETDATE(), 'user'),
(8, 'Cedula', 777888999, 'Frank White', 'frankwhite@example.com', '7778889999', 'Active', '1995-08-08', GETDATE(), 'user'),
(9, 'Cedula', 101010101, 'Grace Black', 'graceblack@example.com', '1010101010', 'Inactive', '1996-09-09', GETDATE(), 'user'),
(10, 'Cedula', 202020202, 'Henry Blue', 'henryblue@example.com', '2020202020', 'Active', '1997-10-10', GETDATE(), 'user'),
(11, 'Cedula', 303030303, 'Ivy Brown', 'ivybrown@example.com', '3030303030', 'Inactive', '1998-11-11', GETDATE(), 'user'),
(12, 'Cedula', 404040404, 'Jack Green', 'jackgreen@example.com', '4040404040', 'Active', '1999-12-12', GETDATE(), 'user'),
(13, 'Cedula', 505050505, 'Karen White', 'karenwhite@example.com', '5050505050', 'Inactive', '2000-01-13', GETDATE(), 'user'),
(14, 'Cedula', 606060606, 'Leo Black', 'leoblack@example.com', '6060606060', 'Active', '2001-02-14', GETDATE(), 'user'),
(15, 'Cedula', 707070707, 'Mia Blue', 'miablue@example.com', '7070707070', 'Inactive', '2002-03-15', GETDATE(), 'user'),
(16, 'Cedula', 808080808, 'Noah Brown', 'noahbrown@example.com', '8080808080', 'Active', '2003-04-16', GETDATE(), 'user'),
(17, 'Cedula', 909090909, 'Olivia Green', 'oliviagreen@example.com', '9090909090', 'Inactive', '2004-05-17', GETDATE(), 'user'),
(18, 'Cedula', 111111111, 'Paul White', 'paulwhite@example.com', '1111111111', 'Active', '2005-06-18', GETDATE(), 'user'),
(19, 'Cedula', 222222222, 'Quinn Black', 'quinnblack@example.com', '2222222222', 'Inactive', '2006-07-19', GETDATE(), 'user'),
(20, 'Cedula', 333333333, 'Rachel Blue', 'rachelblue@example.com', '3333333333', 'Active', '2007-08-20', GETDATE(), 'user');
